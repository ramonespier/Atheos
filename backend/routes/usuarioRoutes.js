...
import { adicionarMetasController, metaController, atualizarMetaController, excluirMetasController} from "../controllers/MetaController.js";
...
router.put('/dashboard/metas/:id', authMiddleware, atualizarMetaController)
